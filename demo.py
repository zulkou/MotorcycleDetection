...
def vis(dets, srcimg, letterbox_scale, fps=None):
    ...
    bbox_count = 0  # Initialize bounding box count
    ...
    for det in dets:
        ...
        if classes[cls_id] == 'motorcycle':
            ...
            bbox_count += 1  # Increment bounding box count

    # Display bounding box count in top right screen
    bbox_count_text = "Count: {}".format(bbox_count)
    cv.putText(res_img, bbox_count_text, (res_img.shape[1] - 200, 25), cv.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 2)
